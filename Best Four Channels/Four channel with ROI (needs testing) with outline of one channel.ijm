...
for (i=0; i<list.length; i++) {
	...
	run("8-bit");
	run("8-bit");
	write("finsihed grayscale beta gal");
	saveAs("tif", dir2+"zoom_grayscale_beta gal_"+title);
	saveAs("png", dir2+"zoom_grayscale_beta gal_"+title);
	write("finished saving beta gal");
	selectWindow(three);
